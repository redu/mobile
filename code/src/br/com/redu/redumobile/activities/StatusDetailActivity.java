...
public class StatusDetailActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		StatusComposer statusComposer = (StatusComposer) findViewById(R.id.status_composer);
		if (mStatus.isActivityType() || mStatus.isAnswerType() || mStatus.isHelpType()) {
			statusComposer.setVisibility(View.VISIBLE);
			statusComposer.setOnStatusComposerListener(new OnStatusComposerListener() {
				@Override
			...
			statusComposer.setVisibility(View.GONE);
		}
		...
		protected void onPostExecute(List<br.com.developer.redu.models.Status> answers) {
			if (answers != null) {
				if (answers.size() > 0) {
					...
					mFooterLoadingAnswers.findViewById(R.id.tv_loading).setVisibility(View.GONE);
					mFooterLoadingAnswers.findViewById(R.id.tv_empty_list).setVisibility(View.VISIBLE);
				}
			} else {
